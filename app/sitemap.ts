...
const staticRoutes: StaticRouteConfig[] = [
  ...
  { path: "/mobilier-la-comanda", changeFrequency: "weekly", priority: 0.9 },
  { path: "/paturi-din-lemn-masiv", changeFrequency: "weekly", priority: 0.88 },
  { path: "/mese-din-lemn", changeFrequency: "weekly", priority: 0.88 },
