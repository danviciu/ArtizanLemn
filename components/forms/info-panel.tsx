...
const infoCards: InfoCard[] = [
  {
    title: "Repere de incredere",
    points: [
      "Atelier propriu.",
      "Dialog direct cu echipa care executa proiectul.",
      "Lemn masiv selectat in functie de utilizare.",
      "Finisaje premium calibrate pe stilul interiorului.",
    ],
  },
  {
    ...
    <aside className="space-y-5">
      {infoCards.map((card) => (
        <article key={card.title} className="luxury-card p-6">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-wood-700">
      ...
      <article className="luxury-card border-wood-900/20 bg-wood-950 p-6 text-sand-50">
        ...
        <p className="mt-3 text-sm text-sand-100/90">
          Dimensiunile aproximative sunt suficiente pentru inceput. Daca doresti
          varianta custom, adaptam proiectul in functie de spatiu si stil.
        </p>
      </article>
    </aside>
  );
